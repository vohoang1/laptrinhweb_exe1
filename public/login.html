...
<head>
    ...
    <title>Đăng nhập | Lập trình Web @01/2024</title>
    ...
    <style>
        ...
        .social-btn.github { color: #f0f6fc; }
    </style>
</head>
<body>
    <header>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li><a href="login.html" class="active"><i class="fas fa-sign-in-alt"></i> Đăng nhập</a></li>
